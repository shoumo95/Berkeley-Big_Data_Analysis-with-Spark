# Databricks notebook source exported at Sat, 22 Oct 2016 22:46:43 UTC
# MAGIC %md
...
# TODO: Replace <FILL IN> with appropriate code
uniqueWords = len(wordsRDD.map(lambda x: (x, 1)).reduceByKey(lambda x,y : x+y).collect())
print uniqueWords
...
# TODO: Replace <FILL IN> with appropriate code
shakeWordsRDD = shakespeareWordsRDD.filter(lambda ln : ln != '')
